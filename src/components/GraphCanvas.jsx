...
//         // 2) Evaluate y = f(x)
//         const yFunc = equation.split('=')[1].trim();
//         const yFunction = new Function('x', `return ${yFunc}`);
//         let yVal;
//         try {
...
//         // 3) Convert that y back to canvas
//         const graphCanvasY = origin.y - yVal * scale;

//         // 4) Check distance from mouseY
...
//             // Label text and box
//             const labelText = `(${marker.x.toFixed(2)}, ${marker.y.toFixed(2)})`;
...
//         }
//     }, [width, height, equation, origin, scale, marker]);
...
//             if (isMouseNearGraph(equation, mouseX, mouseY, origin, scale, 10)) {
